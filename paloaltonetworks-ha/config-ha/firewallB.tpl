    ...
    <entry name="localhost.localdomain">
      ...
      <deviceconfig>
        <system>
          ...
          <dns-setting>
            <servers>
              <primary>254.169.254.169</primary>
              <secondary>169.254.169.254</secondary>
            </servers>
          </dns-setting>
          <ntp-servers>
            <primary-ntp-server>
        ...
        <high-availability>
          <interface>
            ...
            <ha2>
              ...
              <ip-address>192.168.30.3</ip-address>
              <netmask>255.255.255.0</netmask>
      ...
      <vsys>
        <entry name="vsys1">
          ...
          <rulebase>
            <nat>
              <rules>
                ...
                <entry name="Traffic from VMs to Internet" uuid="9d96bb2d-2325-4cb0-a865-556721d99fb5">
                  <source-translation>
                    <dynamic-ip-and-port>
                      <translated-address>
            ...
            <security>
              <rules>
                <entry name="Inbound to trust" uuid="b0b24ae4-f812-4e13-bde4-cb28d4d4033d">
                  <to>
                    <member>trust</member>
                  </to>
                  <from>
                ...
                <entry name="Outbound to Internet" uuid="11c96bd1-65e1-4815-90c4-673d67b0ec12">
                  <to>
                    <member>untrust</member>
                  </to>
                  <from>
            ...
            <default-security-rules>
              <rules>
                <entry name="intrazone-default" uuid="3ba93518-1d71-4a57-aa7a-58f078be54f0">
                  <action>deny</action>
                  <log-start>no</log-start>
                  <log-end>yes</log-end>
                </entry>
                <entry name="interzone-default" uuid="aed29cd6-be2d-4699-be9b-f11776e42ce5">
                  <action>deny</action>
                  <log-start>no</log-start>
                  <log-end>yes</log-end>
                </entry>
          ...
          <address>
            <entry name="fw-trust">
              <ip-netmask>192.168.2.4</ip-netmask>
            </entry>
            <entry name="fw-untrust">
              <ip-netmask>192.168.1.4</ip-netmask>
            </entry>
            <entry name="db-vcn-vm">
              <ip-netmask>10.0.1.3</ip-netmask>
            </entry>
            <entry name="web-vcn-vm">
              <ip-netmask>10.0.0.3</ip-netmask>
            </entry>
            <entry name="web-vcn-lb">
              <ip-netmask>10.0.0.134</ip-netmask>
            </entry>
          </address>
        </entry>
      </vsys>
